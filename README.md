...
with a strong focus on **data-driven manufacturing, analysis pipelines, and visualization**.
...
- 🔬 **Multi-source data synchronization** and processing for industrial systems (WAAM)
- 🤖 **Machine learning pipelines**: clustering, classification, anomaly detection
- 📊 **Data analysis & visualization** for complex technical datasets
- 🧩 **Computational design workflows** combining geometry, data, and fabrication

---

## Selected Projects

### 🔧 WAAM Data Synchronization & Analysis Framework
Geometry-based and temporal synchronization of multi-stream WAAM data  
for process monitoring and anomaly detection.

🔗 [Project & Publications](https://github.com/SergejsKopils/TSI-Institute)  
🛠 Python, pandas, NumPy, scikit-learn, Plotly, Dash, Open3D

---

### 📰 Adverse Media Monitoring & Risk Assessment System
Automated AI-driven system for identifying reputational risks from online sources.

🔗 [Repository](https://github.com/SergejsKopils/Artificial-Intelligence-Group-Project)  
...
🔗 [Data Projects Collection](https://github.com/SergejsKopils/TSI-Institute)
...
![Top Langs](https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=SergejsKopils&layout=compact&theme=tokyonight)
...
<!--
    ...
    Developed methods for [spatiotemporal synchronization](https://github.com/SergejsKopils/TSI-Institute/tree/main/TSI-Thesis-waam-sync-anomaly-framework/src/ProcessDataIntegration) of [multi-source](https://github.com/SergejsKopils/TSI-Institute/tree/main/TSI-Thesis-waam-sync-anomaly-framework/data) WAAM data streams to enable [anomaly detection](https://github.com/SergejsKopils/TSI-Institute/tree/main/TSI-Thesis-waam-sync-anomaly-framework/src/AnomalyDetection) and process monitoring in metal additive manufacturing. The thesis combines data preprocessing, [synchronization algorithms](https://github.com/SergejsKopils/TSI-Institute/tree/main/TSI-Thesis-waam-sync-anomaly-framework/src/ProcessData_ClusterByZ_DBSCAN), and [visualization](https://github.com/SergejsKopils/TSI-Institute/blob/main/TSI-Thesis-waam-sync-anomaly-framework/src/1MethodGroundTruth/output/plots_GroundTruth_layers/all_layers_3D.png) techniques to improve process quality and control.
